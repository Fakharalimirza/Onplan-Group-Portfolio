...
export const companydetailslibrary: Record<string, CompanyDetail> = {
  'onplan': {
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/onplanuae', username: '@onplanuae' },
  ...
  'snagx-': {
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/snagxae', username: '@snagxae' },
  ...
  'sufsaf-': {
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/alsufsaf', username: '@alsufsaf' }
    ]
  },
  'onplangt-': {
    id: '4',
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/onplan.gt', username: '@onplan.gt' },
  ...
  'authentic': {
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/authenticuae', username: '@authenticuae' }
    ]
  },
  'touchup': {
    id: '6',
    ...
    socialLinks: [
      ...
      { platform: 'instagram', url: 'https://www.instagram.com/touchup.service', username: '@touchup.service' }
    ]
  }
};
